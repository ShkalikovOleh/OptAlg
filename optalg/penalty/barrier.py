...
from ..descent.descent_base import DescentOptimizerBase
from ..optimizer import OptimizeResult
from .penalty_base import CustomizablePenaltyBase
from .utils import *


class Barrier(CustomizablePenaltyBase):
    """
    ...
    def __init__(self, unc_optimizer: DescentOptimizerBase,
                 r_eq_generator: Generator[float, None, None] = r_generator(1/2, 4),
                 r_ineq_generator: Generator[float, None, None] = r_generator(1, 1/4),
